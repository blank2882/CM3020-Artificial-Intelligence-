...
def create_landscape():
    ...
    mountain = p.loadURDF("gaussian_pyramid.urdf", mountain_pos, mountain_orientation, useFixedBase=1)

    # Get the bounding box of the mountain
    mountain_box = p.getAABB(mountain)

    # Calculate the height of the mountain
    mountain_height = mountain_box[1][2] - mountain_box[0][2]

    # Return the height of the mountain and the ID of the mountain in the simulation
    return mountain_height, mountain
