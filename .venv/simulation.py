...
class Simulation: 
    def __init__(self, sim_id=0, iterations=2400):
    ...
    def run_creature(self, cr):
        ...
        # add the mountain
        mountain_height, mountain = envt.create_landscape()
        ...
        p.resetBasePositionAndOrientation(cid, [7, 0, 2], [0, 0, 0, 1], physicsClientId=pid)
        ...
        for step in range(self.iterations):
            ...
            try:
                ...
                # update distance to peak
                cr.update_dist_to_peak(mountain_top = mountain_top)
                cr.check_mountain_contact(mid=mountain)
            except p.error as e:
                print(e)
                # if the creature is out of bounds, mark it as failed
                cr.cr_failed()
                break
